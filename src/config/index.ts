...
export const MONGO_PROTOCOL = getEnvironmentValue("MONGO.PROTOCOL", "mongodb+srv");
export const MONGO_USER     = getEnvironmentValue("MONGO.USER");
export const MONGO_PASSWORD = getEnvironmentValue("MONGO.PASSWORD");
export const MONGO_AUTH = MONGO_USER ? `${MONGO_USER}:${MONGO_PASSWORD}@` : "";
export const MONGO_HOST_AND_PORT = getEnvironmentValue("MONGO.HOSTANDPORT");
export const MONGO_URI = `${MONGO_PROTOCOL}://${MONGO_AUTH}${MONGO_HOST_AND_PORT}`;
export const MONGO_DB_NAME = getEnvironmentValue("MONGO.DBNAME","services_dashboard");
export const MONGO_COLLECTION_PROJECTS = getEnvironmentValue("MONGO.COLLECTION.PROJECTS","projects");
