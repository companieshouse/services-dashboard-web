...
| [aws_lb.dev_tools](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/lb) | data source |
| [aws_lb_listener.dev_tools_listener](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/lb_listener) | data source |
...
| <a name="input_environment"></a> [environment](#input\_environment) | The environment name, defined in environment's vars. | `string` | n/a | yes |
...
| <a name="input_services_dashboard_web_test_version"></a> [services\_dashboard\_web\_test\_version](#input\_services\_dashboard\_web\_test\_version) | The version of the services dashboard web test container to run. | `string` | n/a | yes |
| <a name="input_services_dashboard_web_version"></a> [services\_dashboard\_web\_version](#input\_services\_dashboard\_web\_version) | The version of the services dashboard web container to run. | `string` | n/a | yes |
